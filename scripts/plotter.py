...
with open('results/to_plot/1138_bus.mtx_results.txt', 'r') as f:
    text = f.read()
    text_list = eval(text)
...
with open('results/to_plot/bcspwr08.mtx_results.txt', 'r') as f:
    text = f.read()
    text_list = eval(text)
    par_results.append(text_list[0])
    CSR2_results.append(text_list[1])
...
with open('results/to_plot/bcspwr10.mtx_results.txt', 'r') as f:
    text = f.read()
    text_list = eval(text)
    par_results.append(text_list[0])
    CSR2_results.append(text_list[1])
...
with open('results/to_plot/bcsstk25.mtx_results.txt', 'r') as f:
    text = f.read()
    text_list = eval(text)
    par_results.append(text_list[0])
    CSR2_results.append(text_list[1])
...
with open('results/to_plot/illc1850.mtx_results.txt', 'r') as f:
    text = f.read()
    text_list = eval(text)
    par_results.append(text_list[0])
    CSR2_results.append(text_list[1])
...
plt.legend()
plt.savefig('plots/speedup_plot.png', bbox_inches='tight')